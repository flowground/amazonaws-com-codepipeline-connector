# ![LOGO](logo.png) AWS CodePipeline MSP Connector

## Description

A generated MSP connector for the AWS CodePipeline API (version 2015-07-09).
...
flowground :- Telekom iPaaS / amazonaws-com-codepipeline-connector<br/>
